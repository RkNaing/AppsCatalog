...
class TestAppDataProvider : AppDataProvider {
    ...
    override fun getAppServices(context: Context, packageName: String): List<AppComponent> {
    ...
    override fun getAppActivities(context: Context, packageName: String): List<AppComponent> {
        return generateDummyAppComponent(
            count = 360,
            packageName = packageName,
    ...
    override fun getAppReceivers(context: Context, packageName: String): List<AppComponent> {
        return generateDummyAppComponent(
            count = 36,
            packageName = packageName,
    ...
    override fun getAppPermissions(context: Context, packageName: String): List<AppPermission> {
